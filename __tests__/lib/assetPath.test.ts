...
describe('assetPath utility', () => {
  ...
  it('should prepend basePath when NEXT_PUBLIC_BASE_PATH is set', () => {
    process.env.NEXT_PUBLIC_BASE_PATH = '/technomonasteries.org'
    expect(assetPath('/logo.png')).toBe('/technomonasteries.org/logo.png')
  })

  it('should handle paths with subdirectories', () => {
    process.env.NEXT_PUBLIC_BASE_PATH = '/technomonasteries.org'
    expect(assetPath('/images/hero.jpg')).toBe('/technomonasteries.org/images/hero.jpg')
  })

  it('should handle root path', () => {
    process.env.NEXT_PUBLIC_BASE_PATH = '/technomonasteries.org'
    expect(assetPath('/')).toBe('/technomonasteries.org/')
  })
})
