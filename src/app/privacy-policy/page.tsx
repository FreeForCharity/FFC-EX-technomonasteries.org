        ...
        <div id="aria-font">
          ...
          <ul className="list-inside list-disc space-y-[4px] pb-[1em]">
            <li className="text-[14px] text-[#666] leading-[24px] font-[500]">
              ...
              Manager container requires your explicit opt-in. You can withdraw consent at any time
              via the Cookie Preferences link in the footer; this site then deletes the tracking
              cookies it set, Google&apos;s tags return to the cookieless state, and the container
              stops running consent-gated tags from your next page view.
            </li>
            <li className="text-[14px] text-[#666] leading-[24px] font-[500]">
          ...
          <p className="text-[14px] text-[#666] pb-[10px] leading-[24px] font-[500]">
            ...
            recording (Microsoft Clarity) and marketing (Meta Pixel) are not loaded by this
